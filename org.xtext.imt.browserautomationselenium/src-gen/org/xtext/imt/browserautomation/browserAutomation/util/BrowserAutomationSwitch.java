...
public class BrowserAutomationSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        RefElement refElement = (RefElement)theEObject;
        T result = caseRefElement(refElement);
        if (result == null) result = caseVerifiable(refElement);
        if (result == null) result = caseClickable(refElement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        OPEN_BROWSER opeN_BROWSER = (OPEN_BROWSER)theEObject;
        T result = caseOPEN_BROWSER(opeN_BROWSER);
        if (result == null) result = caseInstruction(opeN_BROWSER);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Ref Element</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Ref Element</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRefElement(RefElement object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseOPEN_BROWSER(OPEN_BROWSER object)
  {
    return null;
  }
