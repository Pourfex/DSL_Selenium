...
public class TestImpl extends MinimalEObjectImpl.Container implements Test
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BrowserAutomationPackage.TEST__NAME, oldName, name));
  }
  ...
  public EList<Instruction> getInstructions()
  {
    ...
    {
      instructions = new EObjectContainmentEList<Instruction>(Instruction.class, this, BrowserAutomationPackage.TEST__INSTRUCTIONS);
    }
    return instructions;
  }
